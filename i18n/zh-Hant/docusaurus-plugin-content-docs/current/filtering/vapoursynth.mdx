...
為了解決這些挑戰，會使用影片濾鏡技術。目前，主要有三個影片濾鏡的軟件框架：
...
VapourSynth 是 AviSynth 的 21 世紀升級版和重寫，AviSynth 最初由 Ben Rudiak-Gould、Edwin van Eggelen、Klaus Post、Richard Berg 和 Ian Brabham 於 2000 年 5 月創建。這次完全重寫的一個最吸引人的特點之一是改進的多線程能力，這是在 AviSynth 的老舊基礎設施中存在困難的領域。

...
Codec Wiki 是一個社群維護的編碼百科全書。

## 在您貢獻之前

1. 當您為 Codec Wiki 作出貢獻時，即表示您已閱讀並同意我們的《條款與條件》、《隱私政策》及《行為準則》。
2. 確保您對所要貢獻的內容有足夠的理解，能夠對專案有所幫助。第一次貢獻未必做到完美無缺，但請務必仔細檢查您所貢獻的內容，確保其正確性。

**我們目前的優先事項是填充現有頁面的內容。在考慮新增頁面之前，請盡量協助完成此工作。**

如果您不確定條目中的內容是否完全正確，或者認為您的條目需要審核，請在條目頂部附上以下訊息：

:::caution 需要審核
此條目中的內容可能不完全準確，正在進行進一步審核以評估其信息質量。
:::

如果您知道您的條目過短或不完整，請在條目頂部添加以下訊息：
